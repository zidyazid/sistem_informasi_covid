		...
		<div class="row-fluid">
			...
			<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
					<select name="id_posko" id="id_posko" required class="chzn-select" data-placeholder="Pilih Posko.............">
						<option value=""></option>
						...
						<?php
							...
							$unit = new posko($pdo);					
							$query = "SELECT * FROM posko where aktif = 'Y' ";
							$unit->select($query);
...
$("#multi-post").click(function(){
	if(document.multiform.username.value==""){
		...
		if(document.multiform.id_posko.value==""){
			alert("Silahkan Pilih Posko !");
			document.multiform.id_posko.focus();
			return false;
		}
