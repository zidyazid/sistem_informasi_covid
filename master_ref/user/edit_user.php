		...
		<div class="row-fluid">
			<div class="span5">
				...
				<div class="control-group">
					...
					<div class="controls">
					<select name="id_posko" id="id_posko" required class="chzn-select" data-placeholder="Pilih Unit Layanan.............">
						<option value="<?php echo $id_posko ?>"><?php echo $alamat_posko ?></option>
