...
<html lang="en">
	...
	<style type="text/css">
		.login-layout {
		    ...
		    background-image: url("assets/images/sungai.jpg");
							...
							<div class="row-fluid">
								<div class="center">
									<h1>
										...
										<span class="white">Kantor Desa</span>
									</h1>
									<h3 class="white">Kampung Pinang</h3>
								</div>
							</div>
									...
									<div id="login-box" class="login-box visible widget-box no-border">
										<div class="widget-body">
											<div class="widget-main">
												 <div align="center"><img src="assets/images/kampar.png" height="180" width="160" class="img-polaroid"/></div>
